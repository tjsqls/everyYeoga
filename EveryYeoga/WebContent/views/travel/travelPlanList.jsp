					...
					<ul>
						...
						<c:choose>
							<c:when test="${loginedUser eq null}">
								<li class="current"><a
									href="${pageContext.request.contextPath}/user/login.do">로그인</a></li>  | <li class="current"><a
									href="${pageContext.request.contextPath}/user/registUser.do">회원가입</a></li> 
							</c:when>
							<c:otherwise>
								<b>${loginedUser.id}</b> 님!! 환영합니다. <li class="current"><a
									...
									<div class="well">
										<div class="row">
											<div
												...
												<form>
													<span style="float: right"><button type="input"
															style="padding: 10px">검색</button></span> <span
														style="float: right" style="padding: 10px"><input
														placeholder="yyyy/mm/dd" /></span> <span style="float: right"
														style="padding: 10px"><input placeholder="지역" /></span> <input
