...
<body>
	...
	<form action="${pageContext.request.contextPath}/user/regist.do" method="post">
		...
		<tr><th>Date of Birth </th><td><input style="margin-top:20px; width: 300px; height: 40px;" id="birthDate"  name="birthDate"  type="text" value="" placeholder="Please input date of birth">  </td> </tr>
